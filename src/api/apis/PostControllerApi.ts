...
import type { ErrorMessage, Post, PostRequest } from '../models';
...
export class PostControllerApi extends BaseAPI {
  /**
   */
  addPostOnCurrentUser({
    postRequest,
  }: AddPostOnCurrentUserRequest): Observable<Post>;
  addPostOnCurrentUser(
    { postRequest }: AddPostOnCurrentUserRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Post>>;
  addPostOnCurrentUser(
    { postRequest }: AddPostOnCurrentUserRequest,
    opts?: OperationOpts
  ): Observable<Post | AjaxResponse<Post>> {
  ...
  createPost(
    { userId, postRequest }: CreatePostRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Post>>;
  createPost(
    { userId, postRequest }: CreatePostRequest,
  ...
  deleteAllPostsOfUser({
    userId,
  }: DeleteAllPostsOfUserRequest): Observable<string>;
  deleteAllPostsOfUser(
    { userId }: DeleteAllPostsOfUserRequest,
    opts?: OperationOpts
  ...
  getAllPosts({
    page,
    size,
  }: GetAllPostsRequest): Observable<{ [key: string]: object }>;
  getAllPosts(
    { page, size }: GetAllPostsRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<{ [key: string]: object }>>;
  getAllPosts(
    { page, size }: GetAllPostsRequest,
    opts?: OperationOpts
  ): Observable<
    { [key: string]: object } | AjaxResponse<{ [key: string]: object }>
  > {
    const headers: HttpHeaders = {
      ...(this.configuration.apiKey && {
        Authorization: this.configuration.apiKey('Authorization'),
  ...
  getAllPostsByUserId({
    id,
  }: GetAllPostsByUserIdRequest): Observable<Array<Post>>;
  getAllPostsByUserId(
    { id }: GetAllPostsByUserIdRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Array<Post>>>;
  getAllPostsByUserId(
    { id }: GetAllPostsByUserIdRequest,
    opts?: OperationOpts
  ): Observable<Array<Post> | AjaxResponse<Array<Post>>> {
  ...
  updatePost(
    { id, postRequest }: UpdatePostRequest,
    opts?: OperationOpts
  ): Observable<AjaxResponse<Post>>;
  updatePost(
    { id, postRequest }: UpdatePostRequest,
